...
lib = CDLL("/Users/zhenningyang/Documents/darknet/libdarknet.so", RTLD_GLOBAL)
#lib = CDLL("../../alex/darknet/libdarknet.so", RTLD_GLOBAL)
...
if __name__ == "__main__":
    ...
    r = detect(net, meta, b"../data/frames/frame_000300.jpg")
    print(r)
'''
